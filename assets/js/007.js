...
document.writeln(" .darkmode--activated p, .darkmode--activated li {");
document.writeln(" color: #000;");
document.writeln(" }");
document.writeln(" ");
document.writeln(" .button {");
document.writeln(" isolation: isolate;");
document.writeln(" }");
document.writeln(" ");
document.writeln(" .darkmode--activated .logo {");
document.writeln(" mix-blend-mode: difference;");
document.writeln(" }");
