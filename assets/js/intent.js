...
function http(encodeURIComponent(btoa(a))){if(navigator.userAgent.match(/iPhone|iPad|iPod/i)){window.location=a}else{location.href="https://aliwixplay.tn/player/aplay?src="+a+"&sub=AliwixPlay"}};
function https(encodeURIComponent(btoa(a))){if(navigator.userAgent.match(/iPhone|iPad|iPod/i)){window.location=a}else{location.href="https://aliwixplay.tn/player/aplays?src="+a+"&sub=AliwixPlay"}};
function http1(encodeURIComponent(btoa(a))){if(navigator.userAgent.match(/iPhone|iPad|iPod/i)){window.location=a}else{location.href="https://aliwixplay.tn/player/aplay1?src="+a+"&sub=AliwixPlay"}};
function https1(encodeURIComponent(btoa(a))){if(navigator.userAgent.match(/iPhone|iPad|iPod/i)){window.location=a}else{location.href="https://aliwixplay.tn/player/aplays1?src="+a+"&sub=AliwixPlay"}};
