function wuffyplay(b){if(navigator.userAgent.match(/iPhone|iPad|iPod/i)){window.location=b}else{location.href="xmtv://"+btoa(b)+"#Intent;scheme=xmtv;package=co.wuffy.player;end"}};
