...
function vlcplay(b){if(navigator.userAgent.match(/iPhone|iPad|iPod/i)){window.location=b}else{location.href="intent:"+b+"#Intent;package=org.videolan.vlc;S.title=aliwixplay.netlify.app;type=video/mp4;end"}};
function dlna(b){if(navigator.userAgent.match(/iPhone|iPad|iPod/i)){window.location=b}else{location.href="wvc-x-callback://open?url="+b+"#Intent;package=com.instantbits.cast.webvideo;end"}};
